  ...
  return (
    <div>
      <FieldGroup
        ...
        touchedFields={touchedFields}
      />
      <button data-testid="update-values" onClick={() => setFormValues({ ...formValues, _updated: true })}>Update Values</button>
      <button data-testid="update-touched" onClick={() => setTouchedFields({ ...touchedFields, field1: true })}>Update Touched</button>
      <button data-testid="same-rerender" onClick={() => setFormValues({ ...formValues })}>Same Rerender</button>
      <button data-testid="change-group" onClick={() => setGroup({
        ...initialGroup,
  ...
  return (
    <div>
      <FieldGroup
        ...
        touchedFields={{}}
      />
      <button data-testid="switch-control" onClick={() => setUseSecond(true)}>Switch Control</button>
    </div>
  )
}
...
describe('FieldGroup', () => {
  ...
  describe('visibility', () => {
    ...
    it('should not render invisible group', () => {
      ...
      const { container } = render(<TestWrapper group={group} formValues={{ show: false }} />)
    ...
    it('should render group when visibleCondition is met', () => {
      ...
      render(<TestWrapper group={group} formValues={{ show: true }} />)
      expect(screen.getByText('Test Group')).toBeInTheDocument()
    })
  })
  ...
  describe('validateCondition', () => {
    ...
    it('should handle group without validateCondition', () => {
      render(<TestWrapper group={baseGroup} formValues={{}} touchedFields={{}} />)
      expect(screen.getByText('Test Group')).toBeInTheDocument()
    })
  })
  ...
  describe('MemoizedField', () => {
    it('should not render field when visibleCondition is false', () => {
      ...
      render(<TestWrapper group={group} formValues={{ show: false }} />)
