...
describe('FormGenerator', () => {
  ...
  describe('submit button', () => {
    ...
    it('should hide submit button when showSubmitButton=false', () => {
      render(<FormGenerator config={simpleConfig} showSubmitButton={false} />)
      expect(screen.queryByText('Submit')).toBeNull()
    })

    it('should show custom submit button text', () => {
      render(<FormGenerator config={simpleConfig} submitButtonText="Save" />)
  ...
  describe('reset button', () => {
    ...
    it('should show reset button when showResetButton=true', () => {
      render(<FormGenerator config={simpleConfig} showResetButton={true} />)
      expect(screen.getByText('Reset')).toBeInTheDocument()
    })

    it('should show custom reset button text', () => {
      render(<FormGenerator config={simpleConfig} showResetButton={true} resetButtonText="Clear" />)
  ...
  describe('button visibility', () => {
    it('should hide all buttons when both showSubmitButton=false and showResetButton=false', () => {
      render(<FormGenerator config={simpleConfig} showSubmitButton={false} showResetButton={false} />)
      expect(screen.queryByText('Submit')).toBeNull()
      expect(screen.queryByText('Reset')).toBeNull()
    })
  })
  ...
  describe('onChange', () => {
    it('should call onChange when values change', async () => {
      ...
      render(<FormGenerator config={simpleConfig} onChange={onChange} />)
  ...
  describe('onSubmit', () => {
    it('should call onSubmit when form is submitted', async () => {
      ...
      const user = userEvent.setup()
      render(<FormGenerator config={simpleConfig} onSubmit={onSubmit} />)
  ...
  describe('initialValues', () => {
    it('should default to empty object when no initialValues provided', () => {
      const ref = React.createRef<FormGeneratorRef>()
      render(<FormGenerator ref={ref} config={simpleConfig} />)
